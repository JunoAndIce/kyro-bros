                ...
                <div className="container">
                    <div className="columns">
                        <div className="column is-9-desktop">
                            ...
                            <p className="subtitle mt-3 is-6 type-title text-sm! lg:text-xl!">Tents, tables, and chairs for Houston events — delivered, with sidewalls included on every tent.</p>
                            <div className="buttons mt-4">
                                <Link href="/packages" className="button is-danger is-medium is-responsive ">Browse Packages</Link>
